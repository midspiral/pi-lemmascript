 ...
 */
//@ verify
//@ ensures iff($result > 0, v1.major > v2.major || v1.major === v2.major && v1.minor > v2.minor || v1.major === v2.major && v1.minor === v2.minor && v1.patch > v2.patch)
//@ ensures iff($result < 0, v1.major < v2.major || v1.major === v2.major && v1.minor < v2.minor || v1.major === v2.major && v1.minor === v2.minor && v1.patch < v2.patch)
//@ ensures iff($result === 0, v1.major === v2.major && v1.minor === v2.minor && v1.patch === v2.patch)
